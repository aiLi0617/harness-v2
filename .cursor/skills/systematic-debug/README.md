# systematic-debug 使用说明

> 本文件为 systematic-debug 技能的人工说明文档；技能的权威执行规范以 [`SKILL.md`](./SKILL.md) 为准，两者如有出入以 SKILL.md 为准。

<!-- skill-readme:auto -->
## 这个 Skill 是做什么的

`systematic-debug`（结构化调试流程（Systematic Debugging））定义了标准化执行流程。
...
```text
请按 bugfix 工作流处理这个 Bug，根因分析阶段使用 systematic-debug，
